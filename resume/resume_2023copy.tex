...
\datedsubsection{\textbf{Fatigue Driving Intelligent Monitoring System}}{Sep. 2017 -- Jun. 2018}
\role{Leader}{5 members of the group.}
\begin{itemize}
  \item Develop a fatigue driving monitoring system and deploy it to a Raspberry Pi development board.
  \item Attained 73\% and 82\% accuracy rates for daytime and nighttime fatigue detection, respectively.
  \item Developed an Android app to alert drivers in real-time of their fatigue status and provide warning reminders.
  \item Awarded the National Second Prize in the National College Information Security Contest for this project.
\end{itemize}
